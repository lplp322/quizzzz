...
public class TrimmedGame {
    ...
    public TrimmedGame(int id, Question currentQuestion, int roundsLeft, int timer) {
        this.id = id;
    ...
    public TrimmedGame(int id, Question currentQuestion, int roundsLeft, int timer, String jokerUser, int timerJoker) {
        this.id = id;
        this.currentQuestion = currentQuestion;
        this.roundsLeft = roundsLeft;
        this.timer = timer;
